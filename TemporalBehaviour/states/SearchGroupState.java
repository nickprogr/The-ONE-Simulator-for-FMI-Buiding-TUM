package TemporalBehaviour.states;
 ...
 */
public class SearchGroupState extends State {


        private double stateEnterTime = 0;

        public SearchGroupState(DailyBehaviour dailyBehaviour, State state){
        ...
        public Coord getDestination() {
            this.dailyBehaviour.getHost().setName("SearchGroup");
